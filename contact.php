...
<div class="container">
    ...
    <h1>With Large Image</h1>
    <div class="pagenation">&nbsp;<a href="index-2.html">Home</a> <i>/</i> <a href="#">Blog</a> <i>/</i> With Large Image</div>
        ...
        <div class="address_info">
          ...
          <ul>
            <li> <strong>Company Name</strong><br />
              ...
              Website: <a href="index-2.html">www.yoursitename.com</a> </li>
          </ul>
        </div>
        <div class="clearfix"></div>
